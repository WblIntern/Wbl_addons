...
class ResConfigSettings(models.TransientModel):
    ...
    enable_pdf_home = fields.Boolean("Enable PDF Home Page")
    ...
    def get_values(self):
        ...
        res.update(
            ...
            enable_pdf_home=IrConfigParam.get_param('res.config.settings.enable_pdf_home', default=False),
    ...
    def set_values(self):
        ...
        IrConfigParam.set_param('res.config.settings.enable_pdf_home', self.enable_pdf_home)
